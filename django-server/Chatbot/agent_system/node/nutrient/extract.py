...
[사용자 이름]님! 영양소에 대해 궁금하신 점이 많으신 것 같아요. 특히 설문조사 결과를 확인해보니 피로를 느끼고 계시고, 실내에서 주로 활동하신다고 하셨는데요, 이러한 점을 고려하여 몇 가지 영양소를 추천드리고 싶습니다.
...
이 중에서 어떤 영양소에 대해 더 자세히 알고 싶으신가요? 필요하시다면 영양제를 추천해드릴 수도 있어요!
""",
            user_prompt=user_query,
